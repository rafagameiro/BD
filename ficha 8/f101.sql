...
prompt  APPLICATION 101 - Matriculas
--
-- Application Export:
--   Application:     101
--   Name:            Matriculas
--   Date and Time:   10:47 Monday May 7, 2018
--   Exported By:     UMK
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,1191560019522688350));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'MK'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'Matriculas'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F101'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 1198120304026500010 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 1198120908923500013 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 1198123200075500040 + wwv_flow_api.g_id_offset,
  p_error_template=> 1198120711794500013 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20180507103835',
  ...
  p_cust_authentication_process=> '.'||to_char(1198127705985500159 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 2,
  p_default_label_template => 1198126404864500090 + wwv_flow_api.g_id_offset,
  p_default_report_template => 1198125821906500068 + wwv_flow_api.g_id_offset,
  p_default_list_template => 1198125113348500059 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 1198126702801500090 + wwv_flow_api.g_id_offset,
  p_default_button_template => 1198121403331500015 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 1198122317341500037 + wwv_flow_api.g_id_offset,
  p_default_form_template => 1198122430527500037 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 1198123812883500042 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 1198123200075500040 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>1198123200075500040 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 1198122008538500037 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 1198122602938500037 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'UMK',
  p_last_upd_yyyymmddhh24miss=> '20180507103835',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 1198128025561500165 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 1198132326568503277 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
--application/shared_components/user_interface/lov/cursos
 
begin
 
wwv_flow_api.create_list_of_values (
  p_id       => 1198143509196744345 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'CURSOS',
  p_lov_query=> 'select nomecurso, curso'||chr(10)||
'from cursos'||chr(10)||
'order by nomecurso');
...
wwv_flow_api.create_list_of_values (
  p_id       => 1198129903341500335 + wwv_flow_api.g_id_offset,
  p_flow_id  => wwv_flow.g_flow_id,
  p_lov_name => 'Report Row Per Page',
  p_lov_query=> '.'||to_char(1198129903341500335 + wwv_flow_api.g_id_offset)||'.');
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130025271500354 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130124759500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130210047500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130318581500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130405451500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130515777500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130616158500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130726586500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130814004500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_static_lov_data (
  p_id=>1198130900735500369 + wwv_flow_api.g_id_offset,
  p_lov_id=>1198129903341500335 + wwv_flow_api.g_id_offset,
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20180427160229'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 1198129610705500313 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Navigation',
  p_region_name=>'',
  p_plug_template=> 1198123200075500040+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
  p_plug_source_type=> 1198129413817500283 + wwv_flow_api.g_id_offset,
  p_list_template_id=> 1198125212753500059+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198129801448500330 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 1198122008538500037+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(1198129105637500260 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 1198126702801500090+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_plug (
  p_id=> 1198131214349500371 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'CURSOS',
  p_region_name=>'',
...
wwv_flow_api.create_worksheet(
  p_id=> 1198131319858500375+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 1198131214349500371+wwv_flow_api.g_id_offset,
  p_name=> 'CURSOS',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
wwv_flow_api.create_worksheet_column(
  p_id => 1198131427446500400+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 1198131319858500375+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CURSO',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Curso',
  p_report_label           =>'Curso',
  p_sync_form_label        =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198131532017500425+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 1198131319858500375+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'NOMECURSO',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Nomecurso',
  p_report_label           =>'Nomecurso',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'CURSO:NOMECURSO';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1198132500034505138+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 1198131319858500375+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198131723318500430 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
...
'No help is available for this page.'
 ,p_last_updated_by => 'UMK'
 ,p_last_upd_yyyymmddhh24miss => '20180507103544'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198133401248543776 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select MATRICULAS.NUMERO as "Número",'||chr(10)||
'COLOCADOS.NOME as "Nome",'||chr(10)||
'MATRICULAS.DATAMATR as "Data",'||chr(10)||
'CURSOS.NOMECURSO as "Curso"'||chr(10)||
'from MATRICULAS inner join COLOCADOS using (IDCANDIDATO, CURSO)'||chr(10)||
'inner join CURSOS using (CURSO)';

wwv_flow_api.create_page_plug (
  p_id=> 1198133828719543783 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select MATRICULAS.NUMERO as "Número",'||chr(10)||
'COLOCADOS.NOME as "Nome",'||chr(10)||
'MATRICULAS.DATAMATR as "Data",'||chr(10)||
'CURSOS.NOMECURSO as "Curso"'||chr(10)||
'from MATRICULAS inner join COLOCADOS using (IDCANDIDATO, CURSO)'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 1198133919228543783+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_region_id=> 1198133828719543783+wwv_flow_api.g_id_offset,
  p_name=> 'Matriculas',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198134131614543787+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1198133919228543783+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Número',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198134211106543790+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1198133919228543783+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198134301137543790+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1198133919228543783+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198134413271543790+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1198133919228543783+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Curso',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'Número:Nome:Data:Curso';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1198134503674543984+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3,
  p_worksheet_id => 1198133919228543783+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
prompt  ...PAGE 4: Relatório de Matriculas
--
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 4
 ,p_name => 'Relatório de Matriculas'
 ,p_step_title => 'Relatório de Matriculas'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'UMK'
 ,p_last_upd_yyyymmddhh24miss => '20180427163914'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select m.NUMERO "NUMERO",'||chr(10)||
'c.NOME "Nome",'||chr(10)||
'r.NOMECURSO "Curso",'||chr(10)||
'm.DATAMATR "Data de Matrícula",'||chr(10)||
'm.ANO "Ano",'||chr(10)||
'calc_ects(m.NUMERO) "ECTSs"'||chr(10)||
'from "#OWNER#"."MATRICULAS" m, "#OWNER#"."COLOCADOS" c, "#OWNER#"."CURSOS" r'||chr(10)||
'WHERE m.IDCANDIDATO = c.IDCANDIDATO and c.CURSO = r.CURSO and m.ANO = c.ANO'||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 1198139704817638042 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Matriculas',
  p_region_name=>'',
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select m.NUMERO "NUMERO",'||chr(10)||
'c.NOME "Nome",'||chr(10)||
'r.NOMECURSO "Curso",'||chr(10)||
'm.DATAMATR "Data de Matrícula",'||chr(10)||
'm.ANO "Ano",'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 1198139926480638042+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 1198139704817638042+wwv_flow_api.g_id_offset,
  p_name=> 'Matriculas',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:5:&APP_SESSION.::::P5_NUMERO:#NUMERO#',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198140006774638046+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198142421092681486+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Nome',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198142505666681486+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Curso',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198142602070681486+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'Data de Matrícula',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Data De Matrícula',
  p_report_label           =>'Data De Matrícula',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198142710957681488+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 1198143216422717975+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ECTSs',
  p_display_order          =>6,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'F',
  p_column_label           =>'Ectss',
  p_report_label           =>'Ectss',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'NUMERO:IDCANDIDATO:CURSO:DATAMATR:ANO';

wwv_flow_api.create_worksheet_rpt(
  p_id => 1198141502214638243+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 1198139926480638042+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198140716258638048 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1198140625856638048 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 30,
  p_button_plug_id => 1198139704817638042+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(1198121403331500015+wwv_flow_api.g_id_offset),
...
prompt  ...PAGE 5: Criar ou editar matriculas
--
...
wwv_flow_api.create_page (
  p_flow_id => wwv_flow.g_flow_id
 ,p_id => 5
 ,p_name => 'Criar ou editar matriculas'
 ,p_step_title => 'Criar ou editar matriculas'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
...
'No help is available for this page.'
 ,p_last_updated_by => 'UMK'
 ,p_last_upd_yyyymmddhh24miss => '20180427164449'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198136122013637951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Criar ou editar matriculas',
  p_region_name=>'',
  p_plug_template=> 1198122430527500037+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198140911178638049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 1198136409670637954 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
  p_button_sequence=> 30,
  p_button_plug_id => 1198136122013637951+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(1198121403331500015+wwv_flow_api.g_id_offset),
  ...
  p_button_condition=> 'P5_NUMERO',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 1198136728186637956 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
...
wwv_flow_api.create_page_button(
  p_id             => 1198136331155637954 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
...
wwv_flow_api.create_page_button(
  p_id             => 1198136507823637954 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 5,
...
wwv_flow_api.create_page_branch(
  p_id=>1198137527051637971 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
...
wwv_flow_api.create_page_item(
  p_id=>1198137707883637978 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_NUMERO',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 1,
  p_item_plug_id => 1198136122013637951+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 1198126404864500090+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198137921134637993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_IDCANDIDATO',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 20,
  p_item_plug_id => 1198136122013637951+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Idcandidato',
  p_source=>'IDCANDIDATO',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198138108977638028 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_CURSO',
  p_data_type=> 'VARCHAR',
  ...
  p_named_lov=> 'CURSOS',
  p_lov=> 'select nomecurso, curso'||chr(10)||
'from cursos'||chr(10)||
'order by nomecurso',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198138301275638029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_DATAMATR',
  p_data_type=> 'VARCHAR',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198138514097638029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 5,
  p_name=>'P5_ANO',
  p_data_type=> 'VARCHAR',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:MATRICULAS:P5_NUMERO:NUMERO';

wwv_flow_api.create_page_process(
  p_id     => 1198138829079638029 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from MATRICULAS',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:MATRICULAS:P5_NUMERO:NUMERO|IUD';

wwv_flow_api.create_page_process(
  p_id     => 1198139019675638032 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of MATRICULAS',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table MATRICULAS.',
...
wwv_flow_api.create_page_process(
  p_id     => 1198139205656638032 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 5,
  ...
  p_process_when_button_id=>1198136507823637954 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 1198119917524499992 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20180427160228'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 1198128321376500207 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198128424376500237 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 1198128321376500207+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198128521100500249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>1198128607536500249 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(1198121403331500015 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 1198128809706500260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1198128716987500251 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 1198129008854500260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 1198128916505500260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_list (
  p_id=> 1198129413817500283 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Navigation',
  p_list_status=> 'PUBLIC',
  p_list_displayed=> 'BY_DEFAULT',
  p_display_row_template_id=> 1198125113348500059 + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_list_item (
  p_id=> 1198129508288500302 + wwv_flow_api.g_id_offset,
  p_list_id=> 1198129413817500283 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_list_item (
  p_id=> 1198135421598568088 + wwv_flow_api.g_id_offset,
  p_list_id=> 1198129413817500283 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
...
wwv_flow_api.create_list_item (
  p_id=> 1216751216790952178 + wwv_flow_api.g_id_offset,
  p_list_id=> 1198129413817500283 + wwv_flow_api.g_id_offset,
  p_list_item_type=> 'LINK',
  p_list_item_status=> 'PUBLIC',
  p_item_displayed=> 'BY_DEFAULT',
  p_list_item_display_sequence=>40,
  p_list_item_link_text=> 'Editar Matriculas',
...
wwv_flow_api.create_menu (
  p_id=> 1198129105637500260 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>1198129720145500316 + wwv_flow_api.g_id_offset,
  p_menu_id=>1198129105637500260 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>1198133700418543783 + wwv_flow_api.g_id_offset,
  p_menu_id=>1198129105637500260 + wwv_flow_api.g_id_offset,
  p_parent_id=>1198129720145500316 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>1198141105762638049 + wwv_flow_api.g_id_offset,
  p_menu_id=>1198129105637500260 + wwv_flow_api.g_id_offset,
  p_parent_id=>1198129720145500316 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Relatório de Matriculas',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1198141421400638049 + wwv_flow_api.g_id_offset,
  p_menu_id=>1198129105637500260 + wwv_flow_api.g_id_offset,
  p_parent_id=>1198141105762638049 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Criar ou editar matriculas',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>1198131609798500425 + wwv_flow_api.g_id_offset,
  p_menu_id=>1198129105637500260 + wwv_flow_api.g_id_offset,
  p_parent_id=>1198129720145500316 + wwv_flow_api.g_id_offset,
...
prompt  ......Page template 1198119917524499992
...
wwv_flow_api.create_template(
  p_id=> 1198119917524499992 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 1198120010619500009
...
wwv_flow_api.create_template(
  p_id=> 1198120010619500009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120113022500009
...
wwv_flow_api.create_template(
  p_id=> 1198120113022500009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120219320500009
...
wwv_flow_api.create_template(
  p_id=> 1198120219320500009 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120304026500010
...
wwv_flow_api.create_template(
  p_id=> 1198120304026500010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120417462500010
...
wwv_flow_api.create_template(
  p_id=> 1198120417462500010 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120527799500013
...
wwv_flow_api.create_template(
  p_id=> 1198120527799500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120609430500013
...
wwv_flow_api.create_template(
  p_id=> 1198120609430500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120711794500013
...
wwv_flow_api.create_template(
  p_id=> 1198120711794500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198120825096500013
...
wwv_flow_api.create_template(
  p_id=> 1198120825096500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 1198120908923500013
...
wwv_flow_api.create_template(
  p_id=> 1198120908923500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198121021577500013
...
wwv_flow_api.create_template(
  p_id=> 1198121021577500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198121102742500013
...
wwv_flow_api.create_template(
  p_id=> 1198121102742500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198121217591500013
...
wwv_flow_api.create_template(
  p_id=> 1198121217591500013 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 1198121311428500015
...
wwv_flow_api.create_template(
  p_id=> 1198121311428500015 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 1198121403331500015
declare
...
wwv_flow_api.create_button_templates (
  p_id=>1198121403331500015 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1198121510691500024
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1198121510691500024 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1198121617506500024
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1198121617506500024 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 1198121705757500024
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>1198121705757500024 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 1198121803220500024
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198121803220500024 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198121907715500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198121907715500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122008538500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122008538500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122107436500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122107436500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1198122208679500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122208679500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1198122317341500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122317341500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122430527500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122430527500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-blue-top"><div class="rc-blue-top-r">'||chr(10)||
...
prompt  ......region template 1198122502527500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122502527500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122602938500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122602938500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-blue-top"><div class="rc-blue-top-r">'||chr(10)||
...
prompt  ......region template 1198122702524500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122702524500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122803423500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122803423500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198122924187500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198122924187500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 1198123002269500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123002269500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 1198123123006500037
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123123006500037 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198123200075500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123200075500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-blue-top"><div class="rc-blue-top-r">'||chr(10)||
...
prompt  ......region template 1198123331138500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123331138500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198123415214500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123415214500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 1198123526142500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123526142500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198123600187500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123600187500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198123708933500040
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123708933500040 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 1198123812883500042
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123812883500042 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-blue-top"><div class="rc-blue-top-r">'||chr(10)||
...
prompt  ......region template 1198123927939500042
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 1198123927939500042 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-blue-top"><div class="rc-blue-top-r">'||chr(10)||
...
prompt  ......list template 1198124009124500042
...
wwv_flow_api.create_list_template (
  p_id=>1198124009124500042 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 1198124110347500056
...
wwv_flow_api.create_list_template (
  p_id=>1198124110347500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124215800500056
...
wwv_flow_api.create_list_template (
  p_id=>1198124215800500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124315625500056
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198124315625500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124432663500056
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198124432663500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124531488500056
...
wwv_flow_api.create_list_template (
  p_id=>1198124531488500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124625931500056
...
wwv_flow_api.create_list_template (
  p_id=>1198124625931500056 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124700816500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198124700816500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124804957500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198124804957500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198124929793500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198124929793500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198125007668500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198125007668500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198125113348500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198125113348500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198125212753500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198125212753500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 1198125313254500059
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>1198125313254500059 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 1198125406873500059
...
wwv_flow_api.create_row_template (
  p_id=> 1198125406873500059 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198125506093500067
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198125506093500067 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198125628414500067
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198125628414500067 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198125715537500067
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198125715537500067 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198125821906500068
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198125821906500068 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198125917879500068
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198125917879500068 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198126019065500068
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198126019065500068 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 1198126117398500068
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 1198126117398500068 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1198126210665500068
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1198126210665500068 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1198126307780500090
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1198126307780500090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1198126404864500090
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1198126404864500090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1198126522283500090
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1198126522283500090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 1198126608022500090
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 1198126608022500090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1198126702801500090
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 1198126702801500090 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1198126816211500106
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 1198126816211500106 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 1198127505154500120
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 1198127505154500120 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1198126918834500106
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1198126918834500106 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1198127104998500116
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1198127104998500116 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 1198127305413500116
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 1198127305413500116 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 1198127620569500127
begin
wwv_flow_api.create_theme (
  p_id =>1198127620569500127 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 2,
  ...
  p_login_template=>1198119917524499992 + wwv_flow_api.g_id_offset,
  p_default_button_template=>1198121403331500015 + wwv_flow_api.g_id_offset,
  p_default_region_template=>1198123200075500040 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>1198122317341500037 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>1198122430527500037 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>1198126404864500090 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>1198126702801500090 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>1198126918834500106 + wwv_flow_api.g_id_offset,
  p_default_list_template=>1198125113348500059 + wwv_flow_api.g_id_offset,
  p_default_option_label=>1198126404864500090 + wwv_flow_api.g_id_offset,
  p_default_required_label=>1198126608022500090 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 1198136909038637967 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 1198127705985500159
...
wwv_flow_api.create_auth_setup (
  p_id=> 1198127705985500159 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 1198127813977500165
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 1198127813977500165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 1198127907782500165
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 1198127907782500165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
